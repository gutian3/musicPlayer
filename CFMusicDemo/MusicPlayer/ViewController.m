...
#define MUSIC1 @"https://raw.githubusercontent.com/SplitGemini/Music/master/Billie+Eilish+-+Six+Feet+Under.mp3"
#define MUSIC2 @"https://raw.githubusercontent.com/SplitGemini/Music/master/Guo+Ding+-+ShuiXingJi.mp3"
#define MUSIC3 @"https://raw.githubusercontent.com/SplitGemini/Music/master/Kendrick+Lamar+-+HUMBLE.mp3"
#define MUSIC4 @"https://raw.githubusercontent.com/SplitGemini/Music/master/Song+DongYe+-+Guo+YuanChao.mp3"
...
- (void)configDataSource
{
    ...
    NSArray *arr = @[@{@"url":MUSIC1,@"songName":@"少司命 - 客官请进",@"id":@"1",@"image":@"cdImage",@"lyric":str},
                     ...
                     @{@"url":MUSIC4,@"songName":@"Matteo - Panama",@"id":@"3",@"image":@"cdImage3",@"lyric":@"无歌词"}];
